...
EVAL_DATA = "./Result/chapter9_3_ptb.valid"
TEST_DATA = "./Result/chapter9_3_ptb.test"
...
def make_batches(id_list, batch_size, num_step):
    ...
    label_bathes = np.split(label, num_batches, axis=1)
    return list(zip(data_batches, label_bathes))
